...
const NewsLatterBox = () => {
  ...
  return (
    <div
      className="shadow-three dark:bg-gray-dark relative z-10 overflow-hidden bg-white p-6 sm:p-8 lg:p-6 xl:p-8"
      style={{ borderRadius: 22 }}
    >
      <h3 className="mb-3 text-[20px] leading-tight font-bold text-black dark:text-white sm:text-[22px]">
        Get Future Dev updates
      </h3>

      <p className="border-body-color/25 text-body-color mb-7 border-b pb-7 text-sm leading-relaxed dark:border-white/25">
      ...
      <div>
        <input
          ...
          className="border-stroke text-body-color focus:border-primary dark:text-body-color-dark dark:shadow-two dark:focus:border-primary mb-3 w-full border bg-[#f8f8f8] px-4 py-2.5 text-sm outline-hidden transition dark:border-transparent dark:bg-[#2C303B] dark:focus:shadow-none"
        ...
        <input
          ...
          className="border-stroke text-body-color focus:border-primary dark:text-body-color-dark dark:shadow-two dark:focus:border-primary mb-4 w-full border bg-[#f8f8f8] px-4 py-2.5 text-sm outline-hidden transition dark:border-transparent dark:bg-[#2C303B] dark:focus:shadow-none"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="bg-primary shadow-submit hover:bg-primary/90 dark:shadow-submit-dark mb-4 flex w-full cursor-pointer items-center justify-center px-7 py-3 text-sm font-medium text-white duration-300"
          style={{ borderRadius: 16 }}
        />

        <p className="text-body-color dark:text-body-color-dark text-center text-xs leading-relaxed sm:text-sm">
