        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div className="opacity-0 animate-[itemIn_.85s_ease-out_forwards]">
                <button
                      ...
                      >
                        {menuItem.path ? (
                          ...
                          <>
                            ...
                            <div
                              className={`submenu dark:bg-dark relative top-full left-0 rounded-xl bg-white/90 p-2 backdrop-blur-xl transition-[top,opacity,transform] duration-300 lg:invisible lg:absolute lg:top-[110%] lg:block lg:w-[250px] lg:p-4 lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full lg:group-hover:opacity-100 lg:group-hover:translate-y-0 lg:translate-y-1 lg:group-hover:animate-[dropdownIn_.18s_ease-out_forwards] ${
                              ...
                              {menuItem.submenu?.map(
                                (submenuItem: any, si: number) => (
                                  <Link
                                    ...
                                    className="text-dark hover:text-primary block rounded-lg px-3 py-2.5 text-sm dark:text-white/70 dark:hover:text-white opacity-0 animate-[subItemIn_.45s_ease-out_forwards]"
                                    style={{ animationDelay: `${70 + si * 45}ms` }}
                                  >
                                    {submenuItem.title}
                                  </Link>
                                )
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0 opacity-0 animate-[itemIn_1s_ease-out_forwards]">
                {!mounted ? null : !isAuthed ? (
                  ...
                  <div className="group relative hidden md:block">
                    ...
                    "
                    >
                      <span className="h-2.5 w-2.5 rounded-full bg-primary dark:bg-white animate-[pulseDot_1.8s_ease-in-out_infinite]" />
                    ...
                    <div className="dark:bg-dark invisible absolute right-0 top-[110%] w-[240px] rounded-2xl border border-white/10 bg-white/80 p-4 opacity-0 shadow-lg backdrop-blur-xl transition-all duration-200 group-hover:visible group-hover:top-full group-hover:opacity-100 group-hover:animate-[dropdownIn_.18s_ease-out_forwards] dark:bg-[#0B1220]/70">
                      <Link
                        href={profileHref}
                ...
                <div className="ml-2 opacity-0 animate-[itemIn_1.1s_ease-out_forwards]">
                  <ThemeToggler />
                </div>
              </div>
            </div>
